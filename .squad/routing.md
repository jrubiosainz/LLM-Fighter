...
|-----------|----------|----------|
| Architecture, game design, decisions | Morpheus | Project structure, tech choices, game flow design |
| HTML/CSS, Canvas, UI, animations, sprites | Trinity | Character sprites, health bars, backgrounds, arcade UI |
| Combat system, game loop, state machine | Tank | Damage calc, round management, hit detection, game state |
| AI agents, Copilot SDK, model API, strategy | Dozer | Sub-agent system, model selection, real-time thought display |
| Code review | Morpheus | Review PRs, check quality, suggest improvements |
| Testing | Tank | Verify combat mechanics, edge cases |
